package com.tmakerchima.enterpriserag.ingestion;

import com.tmakerchima.enterpriserag.model.EnterpriseChunk;
import com.tmakerchima.enterpriserag.model.EnterpriseDocumentInput;
import com.tmakerchima.enterpriserag.model.EnterpriseDocumentRecord;
import com.tmakerchima.enterpriserag.model.EnterpriseIndexedChunk;
...
public class EnterpriseIngestionService {
     ...
     * 兼容性单文档入库编排。
     *
     * <p>这是受限 HTTP canary 使用的同步路径，不是大规模 corpus 导入路径。
